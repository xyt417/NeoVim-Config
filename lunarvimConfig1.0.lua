...
vim.api.nvim_command("autocmd BufEnter * highlight! link Identifier GruvboxFg2")
vim.api.nvim_command("autocmd BufEnter * highlight! link function GruvboxFg0")
vim.api.nvim_command("autocmd BufEnter * highlight! link Operator GruvboxFg0")
